...
class Journal():
    ...
    def __init__(self, TEMP_SAVE_PATH, FINAL_SAVE_PATH, SOURCE_FILE, type_graphic, use_grid, session_select,TII_select, TIR_select, UIR_select , Monthly_Trend, Yearly_Comparison, Monthly_Trend1, SR_select, image, UII_select):
        ...
        self.AB_FINAL_SAVE_PATH = os.path.abspath('apps/uploads/tempData/webstats/journals/')
        self.AB_FINAL_SAVE_PATH_PERMANENT = os.path.abspath('apps/uploads/finalData/webstats/journals/')
...
#---------- Montly Trend- --------------
    def pivot_montly_trend(self):
        ...
        #        Title of Pivot
        #------------------------#
        Journal.customize_title(self,Sheet3)
        ...
        Journal.style(self, Sheet3, arg1, selection_list, arg4, size)

        #--------------------------#
        #       CRETE CHART
        #-------------------------#
        #Journal.create_chart(self, Sheet3)
...
#---------- PIVOT TABLE- --------------
    def pivot_stats(self):
        ...
        # Esta es la forma de seleccionar el SHEET dentro de work Journal.
        ws = wb.Worksheets('.')
        ...
        #     SORT
        #------------------------#
        #Journal.sort(self,Sheet3)

        #wb.SaveAs(self.AB_FINAL_SAVE_PATH + self.cName + ' ' + 'Journal_Stats' + ' '+ self.startYear +'-'+ self.closeYear +'.xlsx')
    ...
    def style(self, Sheet3, arg1, selection_list, arg4, size):
        ...
        Sheet3.Cells(7,1).Font.Color = Journal.RGB(0,0,0)
        ...
        for i in selection_list:
            ...
            Sheet3.Cells(7,counter).Font.Color = Journal.RGB(0,0,0)
        ...
        Sheet3.Cells(5,1).Font.Color = Journal.RGB(0,0,0)
        ...
        Sheet3.Range(Sheet3.Cells(5,1),Sheet3.Cells(5,2)).Borders(win32c.xlEdgeBottom).Color = Journal.RGB(0, 0, 0)
        Sheet3.Range(Sheet3.Cells(5,1),Sheet3.Cells(5,2)).Borders(win32c.xlEdgeLeft).Color = Journal.RGB(0, 0, 0)
        Sheet3.Range(Sheet3.Cells(5,1),Sheet3.Cells(5,2)).Borders(win32c.xlEdgeRight).Color = Journal.RGB(0, 0, 0)
        Sheet3.Range(Sheet3.Cells(5,1),Sheet3.Cells(5,2)).Borders(win32c.xlEdgeTop).Color = Journal.RGB(0, 0, 0)

        Sheet3.Range(Sheet3.Cells(5,1),Sheet3.Cells(5,2)).Borders(win32c.xlInsideHorizontal).Color = Journal.RGB(0, 0, 0)
        Sheet3.Range(Sheet3.Cells(5,1),Sheet3.Cells(5,2)).Borders(win32c.xlInsideVertical).Color = Journal.RGB(0, 0, 0)

        #---- aHORA A TODO EL pIVOT LE DAMOS grid
        #https://learn.microsoft.com/en-us/office/vba/api/excel.xlbordersindex
        Sheet3.Range(Sheet3.Cells(7,1),Sheet3.Cells((int(lastrow)),(lastcol))).Borders(win32c.xlEdgeBottom).Color = Journal.RGB(0, 0, 0)
        Sheet3.Range(Sheet3.Cells(7,1),Sheet3.Cells((int(lastrow)),(lastcol))).Borders(win32c.xlEdgeLeft).Color = Journal.RGB(0, 0, 0)
        Sheet3.Range(Sheet3.Cells(7,1),Sheet3.Cells((int(lastrow)),(lastcol))).Borders(win32c.xlEdgeRight).Color = Journal.RGB(0, 0, 0)
        Sheet3.Range(Sheet3.Cells(7,1),Sheet3.Cells((int(lastrow)),(lastcol))).Borders(win32c.xlEdgeTop).Color = Journal.RGB(0, 0, 0)

        Sheet3.Range(Sheet3.Cells(7,1),Sheet3.Cells((int(lastrow)),(lastcol))).Borders(win32c.xlInsideHorizontal).Color = Journal.RGB(0, 0, 0)
        Sheet3.Range(Sheet3.Cells(7,1),Sheet3.Cells((int(lastrow)),(lastcol))).Borders(win32c.xlInsideVertical).Color = Journal.RGB(0, 0, 0)
    ...
    def customize_title(self, Sheet3):
        ...
        Sheet3.Cells(3,1).Value = cname1 + ' ' + 'Journal Stats' + ' '+ '  ('+ self.initMonth +' '+self.startYear +' - '+' '+ self.endMonth + ' '+self.closeYear+') '
        ...
        Sheet3.Range('A3','A'+str(lastcol)).Font.Color = Journal.RGB(0, 0, 0)
    ...
    def final(self):
        ...
        wb2.Worksheets('Journal Stats').Activate()
        ...
        if os.path.isfile(self.AB_FINAL_SAVE_PATH_PERMANENT + '\\' + self.cName + '_' + 'Journal_Stats' + '_' + self.initMonth + self.startYear +'-'+ self.endMonth + self.closeYear +'.xlsx'):
            os.remove(self.AB_FINAL_SAVE_PATH_PERMANENT + '\\' + self.cName + '_' + 'Journal_Stats' + '_'+ self.initMonth + self.startYear +'-'+ self.endMonth + self.closeYear +'.xlsx')

        # Ahora guardo el nuevo archivo en la ruta final
        wb2.SaveAs(self.AB_FINAL_SAVE_PATH_PERMANENT + '\\'+ self.cName + '_' + 'Journal_Stats' + '_'+ self.initMonth + self.startYear +'-'+ self.endMonth + self.closeYear +'.xlsx')

        # Salvo en la ruta temporal.
        wb2.SaveAs(self.AB_FINAL_SAVE_PATH + '\\'+ self.cName + '_' + 'Journal_Stats' + '_'+ self.initMonth + self.startYear +'-'+ self.endMonth + self.closeYear +'.xls')
        ...
        find_path = str(self.cName + '_' + 'Journal_Stats' + '_' + self.initMonth + self.startYear +'-'+ self.endMonth + self.closeYear +'.xlsx')
...
#---------------------------------------------------------------------------------------
        ...
        #Sheet3 = Journal.set_table_extra(self, Sheet3)
...
#---------- SET UP THE TABLE FORMAT- --------------
    ...
    def extra_chart(self,path):
        ...
        #https://www.w3schools.com/colors/colors_picker.asp
        Sheet3.Cells(3,1).Font.Color = Journal.RGB(0, 0, 0)
...
#------------------------------------------------------------------------------
    def yearly_comp(self):
        ...
        list, sessions, TIR, UIR, TII, UII = Journal.average(self, Sheet3)

        Journal.trend(self, list, sessions, TIR, UIR, TII, UII,Sheet3)
    ...
    def average(self, Sheet3):
        ...
        # ----------------------------------------------------------------
        #https://learn.microsoft.com/en-us/office/vba/api/excel.xlbordersindex
        Sheet3.Range('A'+str(lastrow+1),letter+str(lastrow+1)).Borders(win32c.xlEdgeBottom).Color = Journal.RGB(0, 0, 0)
        Sheet3.Range('A'+str(lastrow+1),letter+str(lastrow+1)).Borders(win32c.xlEdgeLeft).Color = Journal.RGB(0, 0, 0)
        Sheet3.Range('A'+str(lastrow+1),letter+str(lastrow+1)).Borders(win32c.xlEdgeRight).Color = Journal.RGB(0, 0, 0)
        Sheet3.Range('A'+str(lastrow+1),letter+str(lastrow+1)).Borders(win32c.xlEdgeTop).Color = Journal.RGB(0, 0, 0)

        Sheet3.Range('A'+str(lastrow+1),letter+str(lastrow+1)).Borders(win32c.xlInsideHorizontal).Color = Journal.RGB(0, 0, 0)
        Sheet3.Range('A'+str(lastrow+1),letter+str(lastrow+1)).Borders(win32c.xlInsideVertical).Color = Journal.RGB(0, 0, 0)



        Sheet3.Cells((lastrow+1),1).Font.Size = 13
        Sheet3.Cells((lastrow+1),1).Font.Bold = True
        Sheet3.Cells((lastrow+1),1).Font.Color = Journal.RGB(0,0,0)
...
# ----------------------------------------------------------------
        ...
        Sheet3.Cells((lastrow+2),1).Font.Color = Journal.RGB(0,0,0)
        ...
        #https://learn.microsoft.com/en-us/office/vba/api/excel.xlbordersindex
        myRange.Borders(win32c.xlEdgeBottom).Color = Journal.RGB(0, 0, 0)
        myRange.Borders(win32c.xlEdgeLeft).Color = Journal.RGB(0, 0, 0)
        myRange.Borders(win32c.xlEdgeRight).Color = Journal.RGB(0, 0, 0)
        myRange.Borders(win32c.xlEdgeTop).Color = Journal.RGB(0, 0, 0)

        myRange.Borders(win32c.xlInsideHorizontal).Color = Journal.RGB(0, 0, 0)
        myRange.Borders(win32c.xlInsideVertical).Color = Journal.RGB(0, 0, 0)
...
# Poreso despues lo tengo que pasar a PORCENTAGE
        if  self.session_select and (sessions_trend_2019 < 1):
            ...
            if sessions_trend_2019 > 0:
                rgb = [15,209,60]
                Journal.style_trend(self, Sheet3,rgb,row,col,lastrow,letter)
            else:
                rgb = [0,0,255]
                Journal.style_trend(self, Sheet3,rgb,row,col,lastrow,letter)
        else:
...
#-----------------------------------------------
    ...
    def style_trend(self, Sheet3,rgb,row,col, lastrow,letter):
        ...
        Sheet3.Cells((lastrow+row),col).Font.Color = Journal.RGB(rgb[0],rgb[1],rgb[2])
        ...
        Sheet3.Cells((lastrow+row),1).Borders(win32c.xlEdgeBottom).Color = Journal.RGB(0, 0, 0)
        Sheet3.Cells((lastrow+row),1).Borders(win32c.xlEdgeLeft).Color = Journal.RGB(0, 0, 0)
        Sheet3.Cells((lastrow+row),1).Borders(win32c.xlEdgeRight).Color = Journal.RGB(0, 0, 0)
        Sheet3.Cells((lastrow+row),1).Borders(win32c.xlEdgeTop).Color = Journal.RGB(0, 0, 0)


        Sheet3.Cells((lastrow+row),col).Borders(win32c.xlEdgeBottom).Color = Journal.RGB(0, 0, 0)
        Sheet3.Cells((lastrow+row),col).Borders(win32c.xlEdgeLeft).Color = Journal.RGB(0, 0, 0)
        Sheet3.Cells((lastrow+row),col).Borders(win32c.xlEdgeRight).Color = Journal.RGB(0, 0, 0)
        Sheet3.Cells((lastrow+row),col).Borders(win32c.xlEdgeTop).Color = Journal.RGB(0, 0, 0)

        Sheet3.Cells((lastrow+row),col).Borders(win32c.xlInsideHorizontal).Color = Journal.RGB(0, 0, 0)
        Sheet3.Cells((lastrow+row),col).Borders(win32c.xlInsideVertical).Color = Journal.RGB(0, 0, 0)
