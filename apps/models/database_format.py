...
class Database():
    ...
    def __init__(self, TEMP_SAVE_PATH, FINAL_SAVE_PATH, SOURCE_FILE, type_graphic, use_grid, session_select,TII_select, TIR_select, UIR_select , Monthly_Trend, Yearly_Comparison, Monthly_Trend1, SR_select,image,UII_select):
        ...
        self.AB_FINAL_SAVE_PATH = os.path.abspath('apps/uploads/tempData/webstats/databases/')
        self.AB_FINAL_SAVE_PATH_PERMANENT = os.path.abspath('apps/uploads/finalData/webstats/databases/')

        self.AB_TEMP_SAVE_PATH = os.path.abspath('apps/uploads/tempData/')
        ## self.AB_TEMP_SAVE_PATH = 'C:\\Users\\Mauro.CespedesAraya\\github\\dev-work\\OOP_report_reduced\\apps\\uploads\\tempData\\'
        ...
        df1 = df[ (df['Sessions'] != 0) & (df['Searches_Regular'] != 0)]
...
#---------- Montly Trend- --------------
    def pivot_montly_trend(self):
        ...
        if self.SR_select:
            DataField = PivotTable.AddDataField(PivotTable.PivotFields('Searches_Regular'))
            DataField.NumberFormat="#" ##0.00'
            selection_list.append('Searches_Regular')
        else:
            pass
        ...
        #        Title of Pivot
        #------------------------#
        Database.customize_title(self,Sheet3)
        ...
        Database.style(self, Sheet3, arg1, selection_list, arg4, size)

        #--------------------------#
        #       CRETE CHART
        #-------------------------#
        #Database.create_chart(self, Sheet3)
...
#---------- PIVOT TABLE- --------------
    ...
    def style(self, Sheet3, arg1, selection_list, arg4, size):
        ...
        Sheet3.Cells(7,1).Font.Color = Database.RGB(0,0,0)
        ...
        for i in selection_list:
            ...
            Sheet3.Cells(7,counter).Font.Color = Database.RGB(0,0,0)
        ...
        Sheet3.Cells(5,1).Font.Color = Database.RGB(0,0,0)
        ...
        Sheet3.Range(Sheet3.Cells(5,1),Sheet3.Cells(5,2)).Borders(win32c.xlEdgeBottom).Color = Database.RGB(0, 0, 0)
        Sheet3.Range(Sheet3.Cells(5,1),Sheet3.Cells(5,2)).Borders(win32c.xlEdgeLeft).Color = Database.RGB(0, 0, 0)
        Sheet3.Range(Sheet3.Cells(5,1),Sheet3.Cells(5,2)).Borders(win32c.xlEdgeRight).Color = Database.RGB(0, 0, 0)
        Sheet3.Range(Sheet3.Cells(5,1),Sheet3.Cells(5,2)).Borders(win32c.xlEdgeTop).Color = Database.RGB(0, 0, 0)

        Sheet3.Range(Sheet3.Cells(5,1),Sheet3.Cells(5,2)).Borders(win32c.xlInsideHorizontal).Color = Database.RGB(0, 0, 0)
        Sheet3.Range(Sheet3.Cells(5,1),Sheet3.Cells(5,2)).Borders(win32c.xlInsideVertical).Color = Database.RGB(0, 0, 0)

        #---- aHORA A TODO EL pIVOT LE DAMOS grid
        #https://learn.microsoft.com/en-us/office/vba/api/excel.xlbordersindex
        Sheet3.Range(Sheet3.Cells(7,1),Sheet3.Cells((int(lastrow)),(lastcol))).Borders(win32c.xlEdgeBottom).Color = Database.RGB(0, 0, 0)
        Sheet3.Range(Sheet3.Cells(7,1),Sheet3.Cells((int(lastrow)),(lastcol))).Borders(win32c.xlEdgeLeft).Color = Database.RGB(0, 0, 0)
        Sheet3.Range(Sheet3.Cells(7,1),Sheet3.Cells((int(lastrow)),(lastcol))).Borders(win32c.xlEdgeRight).Color = Database.RGB(0, 0, 0)
        Sheet3.Range(Sheet3.Cells(7,1),Sheet3.Cells((int(lastrow)),(lastcol))).Borders(win32c.xlEdgeTop).Color = Database.RGB(0, 0, 0)

        Sheet3.Range(Sheet3.Cells(7,1),Sheet3.Cells((int(lastrow)),(lastcol))).Borders(win32c.xlInsideHorizontal).Color = Database.RGB(0, 0, 0)
        Sheet3.Range(Sheet3.Cells(7,1),Sheet3.Cells((int(lastrow)),(lastcol))).Borders(win32c.xlInsideVertical).Color = Database.RGB(0, 0, 0)
    ...
    def customize_title(self, Sheet3):
        ...
        Sheet3.Cells(3,1).Value = cname1 + ' ' + 'Database Stats' + ' '+ '  ('+ self.initMonth +' '+self.startYear +' - '+' '+ self.endMonth + ' '+self.closeYear+') '
        ...
        Sheet3.Range('A3','A'+str(lastcol)).Font.Color = Database.RGB(0, 0, 0)
    ...
    def final(self):
        ...
        #wb3.Worksheets(sheetname1).Copy(After=wb2.Sheets(1))
        ...
        wb2.Worksheets('Database Stats').Activate()
        ...
        if os.path.isfile(self.AB_FINAL_SAVE_PATH_PERMANENT + '\\' + self.cName + '_' + 'Database_Stats' + '_' + self.initMonth + self.startYear +'-'+ self.endMonth + self.closeYear +'.xlsx'):
            os.remove(self.AB_FINAL_SAVE_PATH_PERMANENT + '\\' + self.cName + '_' + 'Database_Stats' + '_'+ self.initMonth + self.startYear +'-'+ self.endMonth + self.closeYear +'.xlsx')

        # Ahora guardo el nuevo archivo en la ruta final
        wb2.SaveAs(self.AB_FINAL_SAVE_PATH_PERMANENT + '\\'+ self.cName + '_' + 'Database_Stats' + '_'+ self.initMonth + self.startYear +'-'+ self.endMonth + self.closeYear +'.xlsx')

        # Salvo en la ruta temporal.
        wb2.SaveAs(self.AB_FINAL_SAVE_PATH + '\\'+ self.cName + '_' + 'Database_Stats' + '_'+ self.initMonth + self.startYear +'-'+ self.endMonth + self.closeYear +'.xls')
        ...
        find_path = str(self.cName + '_' + 'Database_Stats' + '_' + self.initMonth + self.startYear +'-'+ self.endMonth + self.closeYear +'.xlsx')
...
#---------------------------------------------------------------------------------------
        ...
        #Sheet3 = Database.set_table_extra(self, Sheet3)
...
#---------- SET UP THE TABLE FORMAT- --------------
    def set_table_extra(self, extra_path, col_end):
        ...
        Database.extra_chart(self,path)
    ...
    def extra_chart(self,path):
        ...
        #https://www.w3schools.com/colors/colors_picker.asp
        Sheet3.Cells(3,1).Font.Color = Database.RGB(0, 0, 0)
        ...
        if x == 'xl3DColumn':
            # HAcemos esto para que el grafico se ajuste al numero de columnas.
            if cols == 3:
                Sheet3.Shapes.AddChart(win32c.xl3DColumn,400,90,600,350).Select()
                Sheet3.Shapes.AddPicture(image,True,True,875, 105,-1,-1)
            elif cols == 4:
                Sheet3.Shapes.AddChart(win32c.xl3DColumn,500,90,600,350).Select()
                Sheet3.Shapes.AddPicture(image,True,True,975, 105,-1,-1)
            elif cols == 5:
                Sheet3.Shapes.AddChart(win32c.xl3DColumn,600,90,600,350).Select()
                Sheet3.Shapes.AddPicture(image,True,True,1075, 105,-1,-1)
            else:
                Sheet3.Shapes.AddChart(win32c.xl3DColumn,700,90,600,350).Select()
...
#------------------------------------------------------------------------------
    def yearly_comp(self):
        ...
        list, sessions, SR, TIR, UIR, UII = Database.average(self, Sheet3)

        Database.trend(self,sessions, SR, TIR, UIR, UII, Sheet3)
    ...
    def average(self, Sheet3):
        ...
        for index, row in df.iterrows():
            if row['Year'] == 2019:
                ...
                SR_2019.append(row['Searches_Regular'])
                ...
                SR_2020.append(row['Searches_Regular'])
                ...
                SR_2021.append(row['Searches_Regular'])
                ...
                SR_2022.append(row['Searches_Regular'])
        ...
        avg_SR_2019 = sum(SR_2019)/year
        avg_SR_2020 = sum(SR_2020)/year
        avg_SR_2021 = sum(SR_2021)/year
        avg_SR_2022= sum(SR_2022)/year

        avg_SR_list.append(avg_SR_2019)
        avg_SR_list.append(avg_SR_2020)
        avg_SR_list.append(avg_SR_2021)
        avg_SR_list.append(avg_SR_2022)

        avg_SR = round(sum(avg_SR_list))
        ...
        final = [avg_sessions, avg_SR, avg_TIR, avg_UIR, avg_UII]
        ...
        SR = {'2019':SR_2019,'2020':SR_2020,'2021':SR_2021,'2022':SR_2022}
        ...
        # ----------------------------------------------------------------
        #https://learn.microsoft.com/en-us/office/vba/api/excel.xlbordersindex
        Sheet3.Range('A'+str(lastrow+1),letter+str(lastrow+1)).Borders(win32c.xlEdgeBottom).Color = Database.RGB(0, 0, 0)
        Sheet3.Range('A'+str(lastrow+1),letter+str(lastrow+1)).Borders(win32c.xlEdgeLeft).Color = Database.RGB(0, 0, 0)
        Sheet3.Range('A'+str(lastrow+1),letter+str(lastrow+1)).Borders(win32c.xlEdgeRight).Color = Database.RGB(0, 0, 0)
        Sheet3.Range('A'+str(lastrow+1),letter+str(lastrow+1)).Borders(win32c.xlEdgeTop).Color = Database.RGB(0, 0, 0)

        Sheet3.Range('A'+str(lastrow+1),letter+str(lastrow+1)).Borders(win32c.xlInsideHorizontal).Color = Database.RGB(0, 0, 0)
        Sheet3.Range('A'+str(lastrow+1),letter+str(lastrow+1)).Borders(win32c.xlInsideVertical).Color = Database.RGB(0, 0, 0)



        Sheet3.Cells((lastrow+1),1).Font.Size = 13
        Sheet3.Cells((lastrow+1),1).Font.Bold = True
        Sheet3.Cells((lastrow+1),1).Font.Color = Database.RGB(0,0,0)
        ...
        if  self.SR_select:
            Sheet3.Cells((lastrow+1),3).Value = final[1]
        else:
            pass

        if self.TIR_select == 'Total_Item_Requests':
            Sheet3.Cells((lastrow+1),4).Value = final[2]
        else:
            pass

        if self.UIR_select == 'Unique_Item_Requests':
            Sheet3.Cells((lastrow+1),5).Value = final[3]
        else:
            pass


        # Una vez que tenemos toda la infomracion la regresamos a la funcion.
        return final, sessions, SR, TIR, UIR, UII

    def trend(self,sessions, SR, TIR, UIR, UII, Sheet3):
...
# -------  Trend 2020 -2019
            if key == '2019':
                # Siempre se compara con el año anterior para saber la tendencia
                if sum(sessions[key]) > 0:
                    SR_trend_2019 = sum(SR['2020'])/sum(SR[key])-1
                else:
                    # Si al final resulta 0 entonces le doy un 1 para que no me de el errores
                    # Despues tengo que pasarlo a porcentaje y me daria 100%. Esto significa que no existen datos
                    SR_trend_2019 = 1
...
# -------  Trend 2021 - 2020
                ...
                if sum(sessions[key]) > 0:
                    SR_trend_2120 = sum(SR['2021'])/sum(SR[key])-1
                else:
                    SR_trend_2120 = 1
...
# -------  Trend 2022 - 2021
                ...
                if sum(sessions[key]) > 0:
                    SR_trend_2221 = sum(SR['2022'])/sum(SR[key])-1
                else:
                    SR_trend_2221 = 1
...
# ----------------------------------------------------------------
        ...
        Sheet3.Cells((lastrow+2),1).Font.Color = Database.RGB(0,0,0)
        ...
        #https://learn.microsoft.com/en-us/office/vba/api/excel.xlbordersindex
        myRange.Borders(win32c.xlEdgeBottom).Color = Database.RGB(0, 0, 0)
        myRange.Borders(win32c.xlEdgeLeft).Color = Database.RGB(0, 0, 0)
        myRange.Borders(win32c.xlEdgeRight).Color = Database.RGB(0, 0, 0)
        myRange.Borders(win32c.xlEdgeTop).Color = Database.RGB(0, 0, 0)

        myRange.Borders(win32c.xlInsideHorizontal).Color = Database.RGB(0, 0, 0)
        myRange.Borders(win32c.xlInsideVertical).Color = Database.RGB(0, 0, 0)
        ...
        all_2019 = [sessions_trend_2019, SR_trend_2019, TIR_trend_2019, UIR_trend_2019]
        all_2120 = [sessions_trend_2120, SR_trend_2120, TIR_trend_2120, UIR_trend_2120]
        all_2221 = [sessions_trend_2221, SR_trend_2221, TIR_trend_2221, UIR_trend_2221]
...
# Poreso despues lo tengo que pasar a PORCENTAGE
        if  self.session_select and (sessions_trend_2019 < 1):
            ...
            if sessions_trend_2019 > 0:
                rgb = [15,209,60]
                Database.style_trend(self, Sheet3,rgb,row,col,lastrow,letter)
            else:
                gb = [0,0,255]
                Database.style_trend(self, Sheet3,rgb,row,col,lastrow,letter)
        else:
...
#------------   SR         ----------------------
#-----------------------------------------------
        if  self.SR_select and ( SR_trend_2019 < 1):
                col = 3
                row =3
                Sheet3.Cells((lastrow+row),col).Value = SR_trend_2019
            ...
            pass
            #-----------------------------------------------
        if  self.SR_select and ( SR_trend_2120 < 1):

            col = 3
            row =4
            Sheet3.Cells((lastrow+row),col).Value = SR_trend_2120
            ...
            pass
            #-----------------------------------------------
        if  self.SR_select and ( SR_trend_2221 < 1):
            col = 3
            row =5
            Sheet3.Cells((lastrow+row),col).Value = SR_trend_2221
...
#-----------------------------------------------
    ...
    def style_trend(self, Sheet3,rgb,row,col, lastrow,letter):
        ...
        Sheet3.Cells((lastrow+row),col).Font.Color = Database.RGB(rgb[0],rgb[1],rgb[2])

        #           EDGES
        # ----------------------------------------------------------------
        #https://learn.microsoft.com/en-us/office/vba/api/excel.xlbordersindex
        # Esto es para que pueda hacer el GRID de la primera columan donde salen las fechas
        Sheet3.Cells((lastrow+row),1).Borders(win32c.xlEdgeBottom).Color = Database.RGB(0, 0, 0)
        Sheet3.Cells((lastrow+row),1).Borders(win32c.xlEdgeLeft).Color = Database.RGB(0, 0, 0)
        Sheet3.Cells((lastrow+row),1).Borders(win32c.xlEdgeRight).Color = Database.RGB(0, 0, 0)
        Sheet3.Cells((lastrow+row),1).Borders(win32c.xlEdgeTop).Color = Database.RGB(0, 0, 0)


        Sheet3.Cells((lastrow+row),col).Borders(win32c.xlEdgeBottom).Color = Database.RGB(0, 0, 0)
        Sheet3.Cells((lastrow+row),col).Borders(win32c.xlEdgeLeft).Color = Database.RGB(0, 0, 0)
        Sheet3.Cells((lastrow+row),col).Borders(win32c.xlEdgeRight).Color = Database.RGB(0, 0, 0)
        Sheet3.Cells((lastrow+row),col).Borders(win32c.xlEdgeTop).Color = Database.RGB(0, 0, 0)

        Sheet3.Cells((lastrow+row),col).Borders(win32c.xlInsideHorizontal).Color = Database.RGB(0, 0, 0)
        Sheet3.Cells((lastrow+row),col).Borders(win32c.xlInsideVertical).Color = Database.RGB(0, 0, 0)
    ...
    #-------------------------------------
        ...
        #-----------------------------------
        sum_UII_yr = self.df.groupby('Year')['Searches_Regular'].sum()
        ...
        #-----------------------------------
        sum_TIR_yr = self.df.groupby('Year')['Unique_Item_Requests'].sum()
    ...
    #-------------------------------------
        ...
        #-----------------------------------
        sum_TII_month = self.df.groupby('Month-Year')['Searches_Regular'].sum()
